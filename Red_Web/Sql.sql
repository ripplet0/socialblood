...
insert  into `donor`(`donor_id`,`donor_name`,`blood_group`,`phone`,`address`,`email`) values (2,'rahul','b+',0,'gduasgdua','abc@gmail.com'),(4,'eewrw',NULL,543545,'ret','dasd@mail');
...
insert  into `feedback`(`feedback_id`,`feedbacks`,`user_id`,`feedback_date`) values (2,'Wow this  is awsome',1,'0002-02-22'),(3,'hi this is very nice',36,'2022-04-05'),(5,'dd',36,'2022-04-05'),(6,'e',36,'2022-04-05'),(7,'e',36,'2022-04-05'),(8,'e',36,'2022-04-05'),(9,'hai',36,'2022-04-05'),(10,'juijj ',4,'2022-04-05'),(11,'uugk',2,'2022-04-05'),(12,'Hi,\r\n Buddys how are you?\r\n....',2,'2022-04-11'),(13,'<h3>hai</h3>\r\n<script>alert(\"hacked\")</script>',1,'2022-04-14'),(14,'so good',1,'2022-05-01');
...
insert  into `login`(`login_Id`,`username`,`password`,`usertype`) values (1,'rob@gmail.com','123456','user'),(2,'ffrfr@gmail.com','123456','bank'),(3,'admin','123456','admin'),(4,'t@gmail.com','apple123','pending'),(6,'hf','098','user');
...
insert  into `stock`(`stock_id`,`blood_bank_id`,`blood_group`,`unit`) values (1,23,'A+','67'),(2,23,'B+','12'),(3,6,'A+','3'),(4,7,'A+','11'),(5,7,'AB+','52'),(6,24,'A+','50'),(7,24,'B+','2'),(8,35,'B+','d'),(9,35,'A+','109'),(10,56,'A+','2'),(11,56,'B+','2'),(12,10,'A+','20'),(13,3,'B+','60');
...
insert  into `user`(`user_id`,`username`,`gender`,`phone`,`address`,`email`,`blood_group`) values (6,'hf','male',91,'nfkjanfs','rob@gmail.com','B+');
